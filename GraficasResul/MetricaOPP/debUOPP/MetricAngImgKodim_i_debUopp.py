...
for k in lsrep:#range(1,25):
    ...
    (a_y,a_x) = (430,400)#(470,150)#(390,380)#(180,75)
    (b_y,b_x) = (500,445)#(540,195)#(460,435)#(250,120)
    (c_y,c_x) = (250,100)#(60,200)#(50,200)#(50,450)#
    (d_y,d_x) = (350,250)#(160,350)#(150,350)#(150,600)#
